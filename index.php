...
<body>
 <nav class="navbar navbar-default navbar-fixed-top" id="navbar">
	<div class="container">
		<a href="#" class="navbar-brand" id="text">LEAF NOW</a>
    ...
    <div class="row">
      ...
      <div class="col-md-3">
        ...
        <form action="add_cart.php" method="post">
          ...
          <a href="/project/homepage.php"> <button type="button" class="btn btn-success">LOG IN</button></a>
          <a href="/project/registration/register.php"><button class="btn btn-success">Sign Up</button></a>
      </div>
</div>
<br>
</div>
